...
def args_parser():
    ...
    parser.add_argument('--buck_rand', type=bool, default=False, help='randomize bucket for sequential cc')
    ...
    parser.add_argument('--root_bias_path', type=str, default=None,
                        help='JSON file with fixed indices for FLTrust/FLTG root dataset')
