...
def main():
    parser = argparse.ArgumentParser(description="Run CIFAR experiments approximating Fig.3.")
    ...
    parser.add_argument("--attack", default="minmax", help="Use min-max to approximate adaptive poisoning")
    parser.add_argument("--results_root", default="new_results_fig3_cifar")
    parser.add_argument("--root_bias_dir", default="new_cifar_bias_configs",
                        help="Directory containing CIFAR root_bias_<bias>.json files")
    ...
    print("====================================")
    print("CIFAR Fig.3 Approximate Experiments")
