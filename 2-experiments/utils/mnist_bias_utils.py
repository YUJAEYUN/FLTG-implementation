...
def main():
    parser = argparse.ArgumentParser(description="Generate MNIST dirichlet splits and biased root datasets.")
    ...
    parser.add_argument("--output_dir", default="mnist_bias_configs")
